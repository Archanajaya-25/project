...
public class validDelete {
  ...
  public void f() throws BiffException, IOException {
	  validation v=new validation();
	    ...
	    String endpoint = v.readexcel(7,10);
      ...
      {
    	  v.writexcel("Test case",11, 13, "Passed");
      }
      else
      {
    	  v.writexcel("Test case",11, 13, "Failed");
      }
      if(response1.statusCode()==200)
      {
    	  v.writexcel("Test case",10, 19, "Failed");
      }
      else
      {
    	  v.writexcel("Test case",10, 19, "Passed");
      }
