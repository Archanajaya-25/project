...
public class validpostLogin {
  ...
  public void f() throws BiffException, IOException {
	  validation v=new validation();
	    ...
	    String endpoint = v.readexcel(7,13);
	    System.out.println(endpoint);
	     String email=v.readexcel(4, 13) ;
	     System.out.println(email);
	     String password=v.readexcel(5, 13) ;
	     System.out.println(password);
	      ...
	      String jsonString = "{\n"
	          ...
	          {
	        	  v.writexcel("Test case",11, 16, "Passed");
	          }
	          else
	          {
	        	  v.writexcel("Test case",11, 16, "Failed");
	          }
